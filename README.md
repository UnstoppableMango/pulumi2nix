...
It also takes [`sdkDrift`](docs/sdks.md#sdk-drift-checks) and a per-language [`generate`](docs/sdks.md#generated-sdks-for-bridged-providers) flag.
...
[docs/sdks.md](docs/sdks.md) covers what surrounds the builders above: overriding `src`, narrowed per-SDK sources, consuming a nodejs SDK from a Pulumi program, [SDK drift checks](docs/sdks.md#sdk-drift-checks), and [generating SDKs](docs/sdks.md#generated-sdks-for-bridged-providers) instead of committing them.
